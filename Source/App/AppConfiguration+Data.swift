...
extension AppConfiguration {
    ...
    func toData() -> Data? {
        ...
        if data == nil { Logger.shared.unexpected(.missingValue, "Configuration could not be archived") }
        return data
    }
    ...
    static func from(_ data: Data) -> AppConfiguration? {
        ...
        if configuration == nil { Logger.shared.unexpected(.missingValue, "Configuration could not be unarchived")}
...
extension AppConfigurations {
    ...
    func toData() -> Data? {
        let data = try? NSKeyedArchiver.archivedData(withRootObject: self, requiringSecureCoding: false)
        if data == nil { Logger.shared.unexpected(.missingValue, "[AppConfiguration] could not be archived") }
        return data
    }
    ...
    static func from(_ data: Data) -> [AppConfiguration] {
        ...
        if configurations == nil { Logger.shared.unexpected(.missingValue, "[AppConfiguration] could not be unarchived") }
